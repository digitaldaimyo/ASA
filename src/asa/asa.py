    ...
    def forward(
        ...
        *,
        ...
        if return_info:
            ...
            if cfg.get("store_read_logits", False):
                info["read_logits"] = read_logits
            if cfg.get("store_write_logits", False):
                info["write_logits"] = write_logits
            ...
            if cfg.get("store_slot_state_norm", False):
                info["slot_state_norm"] = slot_state.norm(dim=-1)
        return out, info
